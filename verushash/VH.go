...
extern void _wrap_Verushash_verushash_v2b2_VH_4119d1d66918a908(uintptr_t arg1, swig_type_3 arg2, uintptr_t arg3);
...
func (arg1 SwigcptrVerushash) Verushash_v2b2(arg2 string, arg3 uintptr) {
	...
	_swig_i_1 := arg2
	_swig_i_2 := arg3
	C._wrap_Verushash_verushash_v2b2_VH_4119d1d66918a908(C.uintptr_t(_swig_i_0), *(*C.swig_type_3)(unsafe.Pointer(&_swig_i_1)), C.uintptr_t(_swig_i_2))
	if Swig_escape_always_false {
		Swig_escape_val = arg2
	}
}
